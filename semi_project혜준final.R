...
df2<-movepop%>%
  filter(상권_코드_명 == "원효로71길")
df3<-movepop%>%
  filter(상권_코드_명 == "원효로67길")
df4<-movepop%>%
  filter(상권_코드_명 == "원효로64길")
df5<-movepop%>%
  filter(상권_코드_명 == "원효로63길")
df6<-movepop%>%
  filter(상권_코드_명 == "원효로58길")
df7<-movepop%>%
  filter(상권_코드_명 == "원효로56길")
df8<-movepop%>%
  filter(상권_코드_명 == "원효로54길")
df9<-movepop%>% ##
  filter(상권_코드_명 == "원효로53길")
df10<-movepop%>%
  filter(상권_코드_명 == "원효로53가길")
df11<-movepop%>%
  filter(상권_코드_명 == "원효로52길")
df12<-movepop%>%
  filter(상권_코드_명 == "원효로48길")
df13<-movepop%>% ##
  filter(상권_코드_명 == "원효로41길")
df14<-movepop%>%
  filter(상권_코드_명 == "새창로42길")
df15<-movepop%>%
  filter(상권_코드_명 == "새창로35길")
df16<-movepop%>%
  filter(상권_코드_명 == "새창로33길")
df17<-movepop%>%
  filter(상권_코드_명 == "원효로")
df18<-movepop%>%
  filter(상권_코드_명 == "새창로")
df19<-movepop%>%
  filter(상권_코드_명 == "백범로")
df20<-movepop%>%
  filter(상권_코드_명 == "원효로97길")
df21<-movepop%>%
  filter(상권_코드_명 == "원효로93길")
df22<-movepop%>%
  filter(상권_코드_명 == "원효로90길")
df23<-movepop%>%##
  filter(상권_코드_명 == "원효로89길")
df24<-movepop%>%
  filter(상권_코드_명 == "원효로84길")
df25<-movepop%>%
  filter(상권_코드_명 == "원효로83길")
df26<-movepop%>%
  filter(상권_코드_명 == "원효로81길")
df27<-movepop%>%
  filter(상권_코드_명 == "원효로80길")
df28<-movepop%>%
  filter(상권_코드_명 == "원효로77길")
df29<-movepop%>%
  filter(상권_코드_명 == "원효로77가길")
df30<-movepop%>%
  filter(상권_코드_명 == "백범로90라길")
df31<-movepop%>%
  filter(상권_코드_명 == "백범로87길")
df32<-movepop%>%
  filter(상권_코드_명 == "백범로81길")
df33<-movepop%>%
  filter(상권_코드_명 == "백범로79다길")
df34<-movepop%>%
  filter(상권_코드_명 == "백범로79나길")
'''
#### 원효로1동 길뽑기
won1<-movepop%>% ##
  filter(상권_코드_명 == "원효로53길")
...
#### 원으로 맵그리기
central_point_coordinates <- c(lng = yongp$경도[1],lat = yongp$위도[1])
